...
import Breadcrumb1 from '../../Shared/Breadcrumb.vue'
export default {
  components: { Head, Breadcrumb, Breadcrumb1 },
  props: {
    post: Object,
  },
  methods: {
        ...
        <div class="row">
          <div class="col-12 col-xl-8">
            <div class="article__content">
              <a href="category.html" class="article__category">
                {{ post.category.name }}
              </a>
              ...
              <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4 col-xl-12">
                  <div class="interview">
                    ...
                    <h3 class="interview__title">
                      <a href="interview.html"
                        >A Guide to the Work of Ryan Murphy</a
                      >
                    </h3>
                  </div>
                </div>
