            ...
            <div class="row">
                <div class="col-12">
                    <div class="sign__content">
                        <form class="sign__form" @submit.prevent="form.post('/login')">
                            <Link href="/" class="sign__logo">
                                <img src="frontend/img/logo.svg" alt="">
                            </Link>
                            <div class="sign__group">
                                <input type="text" class="sign__input" v-model="form.email" placeholder="Địa chỉ email">
                            ...
                            <div class="sign__group sign__group--checkbox">
                                <input id="remember" v-model="form.remember" type="checkbox" checked="checked">
                            ...
                            <span class="sign__text">Không có tài khoản? <Link href="/register">Đăng ký!</Link></span>
