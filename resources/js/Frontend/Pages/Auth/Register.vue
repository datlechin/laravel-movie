                ...
                <div class="col-12">
                    <div class="sign__content">
                        <form class="sign__form" @submit.prevent="form.post('/register')">
                            ...
                            <div class="sign__group">
                                <input type="text" v-model="form.email" class="sign__input" placeholder="Địa chỉ email">
                                <span class="sign__error" v-if="form.errors.email">{{ form.errors.email }}</span>
                            </div>
                            <div class="sign__group">
                                <input type="password" v-model="form.password" class="sign__input" placeholder="Mật khẩu">
                                <span class="sign__error" v-if="form.errors.password">{{ form.errors.password }}</span>
                            </div>
                            <div class="sign__group">
                                <input type="password" v-model="form.password_confirmation" class="sign__input" placeholder="Nhập lại mật khẩu">
                            </div>
                            <div class="sign__group sign__group--checkbox">
                                <input id="remember" name="remember" type="checkbox" checked="checked">
                                <label for="remember">Tôi đồng ý với <a href="/privacy">Chính sách riêng tư</a></label>
                            </div>
