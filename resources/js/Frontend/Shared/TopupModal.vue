<template>
    <form id="modal-topup" class="zoom-anim-dialog mfp-hide modal modal--form" @submit.prevent="submit">
        ...
        <div v-if="form.type === 'card'">
            ...
            <div class="sign__group sign__group--row">
                ...
                <input class="sign__input" id="serial" v-model="form.serial" type="text" placeholder="Nhập số serial">
            </div>
            <div class="sign__group sign__group--row">
                <label class="sign__label" for="pin">Mã thẻ:</label>
                <input class="sign__input" id="pin" v-model="form.pin" type="text" placeholder="Nhập mã thẻ">
            </div>
        </div>
        <button class="sign__btn" type="submit" :disabled="form.type !== 'card'">Nạp tiền</button>
    </form>
</template>
