<template>
    <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
        <div class="card">
            ...
            <h3 class="card__title"><Link href="details.html">{{ movie.title }}</Link></h3>
            <ul class="card__list">
                <li>Comedy</li>
                <li>{{ releaseYear(movie) }}</li>
            </ul>
        </div>
    </div>
</template>
...
const poster = (movie) => {
    return movie.poster_path ? `https://image.tmdb.org/t/p/w500/${movie.poster_path}` : 'https://via.placeholder.com/500x750'
}
